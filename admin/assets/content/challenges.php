<div class="content container_12">
	...
	<div class="box grid_12" id="box">
		<div class="box-head" style="text-align:center;"><h2>Challenges</h2></div>
			...
			<table class="display" id="datatable">
				<thead>
					<tr>
						...
						<th>Complete</th>
						<th>Tags</th>
						<th class="nosort" style="width:120px;text-align:center;"><a class="tablelink opsrc add-item" href="<?php echo $fullUrl; ?>admin/challenge_selection.php?gameid=<?php echo $_GET['gameid'];?>"></a></th>
...
$(document).ready(function() {
	...
	tableElement.dataTable({
		"bJQueryUI": true,
		"sAjaxSource": "<?php echo $fullUrl; ?>admin/handlers/dataTables/Challenge.DataTables.Ajax.gen.php",
		"sServerMethod": "GET",
		"bServerSide": true,
		"bStateSave": false,
		"bProcessing": true,
		...
		"aoColumns": [
			...
			{ "mData": function ( source, type, val ) {
		        if (type === 'set') {
		          return /*"<a href=\"javascript:void(0);\" onclick=\"ajaxLoadRecord(" + source[0] + ");ShowEdit();\" class=\"tablelink opsrc edit\"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*/"<a href=\"javascript:void(0);\" onclick=\"if(!confirm(\'Are you sure you want to remove this item from the game?\')) return false;ajaxDeleteItem(" + source[0] + ");\" class=\"tablelink opsrc recycle-full\"></a>";
		...
		/**"aoColumns": [
		{ "mData": null, sDefaultContent: "" }, //something like this for username, UserId? from User generated class
		{ "mData": null, sDefaultContent: "", //team points, coded from my own file
		      "sClass": "CenteredColumn" },
		{ "mData": null, sDefaultContent: "", //individual points, coded from already existing file that keeps track of progress
		      "sClass": "CenteredColumn" },
		{ "mData": null, sDefaultContent: "" } //Role/Team will need more thorough coding and will be from my own file
		] This will be where the code for the second half of the page will be**/
		/**Roles.DataTables.Ajax.gen.php will be the file for this code**/
	/*.rowReordering({ 
                    sURL: "<?php echo $fullUrl; ?>admin/handlers/dataTables/Challenge.DataTables.Ajax.gen.php",
                    sRequestType: "GET",
					iIndexColumn: 8
                    });*/
	ReloadMethods();
...
function ajaxDeleteItem(id) {
	...
	var Id = id;	
	var postdata = {};
	postdata['ChallengeId'] = Id;
	postdata['GameId'] = <?php echo $_GET["gameid"]; ?>;
	
	$.post('<?php echo $fullUrl; ?>admin/handlers/gamechallenges/delete.php', postdata, function(output) {
			$('#edit-container').html(output).show();
			$('#modal-loader').hide();
			ajaxLoadRecords();
	});
