...
$ChallengeArray = $ChallengeFactory->GetAll(" where ChallengeId = " . escapeString($Id));
if (count($ChallengeArray) > 0)
{ 
	foreach ($ChallengeArray as &$value)
	{
		?>
<div class="box grid_12">
	<div class="box-head" style="text-align:center;"><h2>Challenge Edit</h2></div>
		<div class="box-content bootstrap">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<input type="hidden" name="hdnId" id="hdnId" value="<?php echo $value->ChallengeId ?>" />
					</div>
				</div>
				<div class="row">
					<div class="col-md-6">
