<?php
	 ...
	 */
	//$aColumns = array('ChallengeId','Title','GameId','Description','CorrectAnswer','SolvedByUserId','PointValue','IsComplete','IsOpen','Tags');
	$aColumns = array('ChallengeId','Title','','Description','CorrectAnswer','SolvedByUserId','PointValue','IsComplete','IsOpen','Tags');
	...
	*/
	...
	//Commenting our this parameter in order to display all challenges.
	/*$GameId = $_GET['GameId'];*/
