...
<?php
	...
	//$aColumns = array('UserRoleId','UserGamesId','GameId','UserId','Username','Title','RoleType','Description');

	$aColumns = array('UserRoleId','Username','Title','RoleType','Description');
	 ...
	 */
	/*$sQuery = "
		SELECT UserRoleId, Username, Title, RoleType, Description
		FROM   $sTable
		$sJoin/*
		$sWhere
		$sOrder
	...
	//need to change for roles 9-16-17
